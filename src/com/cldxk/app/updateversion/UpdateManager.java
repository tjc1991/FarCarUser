package com.cldxk.app.updateversion;
...
public class UpdateManager
{
	...
	private static final int START_UPDATA = 20;
	private static final int START_NO = 21;
...
//		}
			...
			mHttpClient.send(HttpMethod.GET, CldxkConfig.API_UPLOAD_VERSON, new RequestCallBack<String>() {
				...
				public void onSuccess(ResponseInfo<String> arg0) {
					...
					if(null != arg0.result)
					{
						...
						if(null != mHashMap)
						{
							JSONObject jsobj = (JSONObject) JSONObject.parse(arg0.result);
							int version = jsobj.getIntValue("version");
							String name = jsobj.getString("name");
							String urlname = jsobj.getString("url");
							Log.i("tjc", "-->"+version+""+"name="+name+"url="+urlname);
							...
							if(version != versionCode)
							{
								...
								mHandler.sendEmptyMessage(START_NO);
							}
	...
	private void showNoticeDialog()
	{
		...
		builder.setIcon(R.drawable.ys_icon_maomi);
